    ...
    if (selectedPlan === "semanal") {
        ...
        benefits = `
            ...
            <ul>
                ...
                <li><strong>Combinar os dias da semana de segunda a sexta a partir das 07:00 horasda manhã a entrega dos pães.</strong></li>
            </ul>`;
        ...
        benefits = "<strong>Você optou por não assinar um plano no momento.</strong>";
    }
...
document.getElementById("send-to-whatsapp").addEventListener("click", function () {
    ...
    if (plan === "semanal") {
        ...
        planDetails = "Não deseja assinar no momento.";
    }
